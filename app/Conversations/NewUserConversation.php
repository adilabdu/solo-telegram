...
class NewUserConversation extends UserConversation
{
    ...
    public function askFullName() {
        $this->say('Thank you for your interest to join our network.'.chr(10).'SOLO SOLO aims to serve as a fortitude and a life-line for moments of shared crisis. & advocate for the vitality of performing arts to influence policy and action. Share with us your name + contact to get registered on the network.');
